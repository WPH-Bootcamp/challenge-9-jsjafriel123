...
const CardRestaurant = ({
  ...
  return (
    <div
      ...
      className="flex items-center w-full h-[114px] rounded-2xl p-3 gap-2 lg:w-full lg:h-[152px] lg:gap-3 bg-white border shadow-[0_0_20px_#CBCACA40] hover:scale-105 cursor-pointer"
    >
